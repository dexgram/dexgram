...
class AppPreferences {
  ...
  val webrtcPolicyRelay = mkBoolPreference(SHARED_PREFS_WEBRTC_POLICY_RELAY, false)
  ...
  val laMaxFailedAttempts = mkIntPreference(SHARED_PREFS_LA_MAX_FAILED_ATTEMPTS, 3)
  ...
  val usernameExpiryTimestamp = mkLongPreference(SHARED_PREFS_USERNAME_EXPIRY_TIMESTAMP, 0L)
  val usernameUsedPersisted = mkBoolPreference(SHARED_PREFS_USERNAME_USED, false)
  val publicUsername = mkStrPreference(SHARED_PREFS_PUBLIC_USERNAME, null)
  val privateUsername = mkStrPreference(SHARED_PREFS_PRIVATE_USERNAME, null)
  val defaultChatItemTTLInitialized = mkBoolPreference(SHARED_PREFS_DEFAULT_CHAT_ITEM_TTL_INITIALIZED, false)
  val chatItemTTLWeekMigrationDone = mkBoolPreference(SHARED_PREFS_CHAT_ITEM_TTL_WEEK_MIGRATION_DONE, false)
  ...
  val showPublicProfileWarning = mkBoolPreference(SHARED_PREFS_SHOW_PUBLIC_PROFILE_WARNING, true)
  val publicProfileSetupCompleted = mkBoolPreference(SHARED_PREFS_PUBLIC_PROFILE_SETUP_COMPLETED, false)
  ...
  // SECURITY: YubiKey challenge and management key are now encrypted via Android Keystore
  // These old plaintext preferences are deprecated - kept only for migration
  @Deprecated("Use DatabaseUtils.ksYubiKeyChallenge instead")
  val yubiKeyChallenge = mkStrPreference(SHARED_PREFS_YUBIKEY_CHALLENGE, null)
  val yubiKeyUid = mkStrPreference(SHARED_PREFS_YUBIKEY_UID, null)
  val useYubiKeyForDB = mkBoolPreference(SHARED_PREFS_USE_YUBIKEY_FOR_DB, false)
  val yubiKeyPinSet = mkBoolPreference(SHARED_PREFS_YUBIKEY_PIN_SET, false)
  val yubiKeyPukSet = mkBoolPreference(SHARED_PREFS_YUBIKEY_PUK_SET, false)
  val yubiKeyManagementKeySet = mkBoolPreference(SHARED_PREFS_YUBIKEY_MANAGEMENT_KEY_SET, false)
  @Deprecated("No longer stored - PIN is only on YubiKey")
  val yubiKeyPin = mkStrPreference(SHARED_PREFS_YUBIKEY_PIN, null)
  @Deprecated("No longer stored - PUK is only on YubiKey")
  val yubiKeyPuk = mkStrPreference(SHARED_PREFS_YUBIKEY_PUK, null)
  @Deprecated("Use DatabaseUtils.ksYubiKeyManagementKey instead")
  val yubiKeyManagementKey = mkStrPreference(SHARED_PREFS_YUBIKEY_MANAGEMENT_KEY, null)
  // SECURITY: Encrypted storage for YubiKey secrets (via Android Keystore AES-GCM)
  val encryptedYubiKeyManagementKey = mkStrPreference(SHARED_PREFS_ENCRYPTED_YUBIKEY_MANAGEMENT_KEY, null)
  val initializationVectorYubiKeyManagementKey = mkStrPreference(SHARED_PREFS_IV_YUBIKEY_MANAGEMENT_KEY, null)
  val encryptedYubiKeyChallenge = mkStrPreference(SHARED_PREFS_ENCRYPTED_YUBIKEY_CHALLENGE, null)
  val initializationVectorYubiKeyChallenge = mkStrPreference(SHARED_PREFS_IV_YUBIKEY_CHALLENGE, null)
  val encryptedYubiKeyIdentitySecret = mkStrPreference(SHARED_PREFS_ENCRYPTED_YUBIKEY_IDENTITY_SECRET, null)
  val initializationVectorYubiKeyIdentitySecret = mkStrPreference(SHARED_PREFS_IV_YUBIKEY_IDENTITY_SECRET, null)
  val encryptedYubiKeyPublicKey = mkStrPreference(SHARED_PREFS_ENCRYPTED_YUBIKEY_PUBLIC_KEY, null)
  val initializationVectorYubiKeyPublicKey = mkStrPreference(SHARED_PREFS_IV_YUBIKEY_PUBLIC_KEY, null)
  val encryptedYubiKeyPukHash = mkStrPreference(SHARED_PREFS_ENCRYPTED_YUBIKEY_PUK_HASH, null)
  val initializationVectorYubiKeyPukHash = mkStrPreference(SHARED_PREFS_IV_YUBIKEY_PUK_HASH, null)
  val encryptedYubiKeyLockoutState = mkStrPreference(SHARED_PREFS_ENCRYPTED_YUBIKEY_LOCKOUT_STATE, null)
  val initializationVectorYubiKeyLockoutState = mkStrPreference(SHARED_PREFS_IV_YUBIKEY_LOCKOUT_STATE, null)
  val encryptedYubiKeyWrappedDMK = mkStrPreference(SHARED_PREFS_ENCRYPTED_YUBIKEY_WRAPPED_DMK, null)
  val initializationVectorYubiKeyWrappedDMK = mkStrPreference(SHARED_PREFS_IV_YUBIKEY_WRAPPED_DMK, null)
  val encryptedYubiKeyEphemeralPub = mkStrPreference(SHARED_PREFS_ENCRYPTED_YUBIKEY_EPHEMERAL_PUB, null)
  val initializationVectorYubiKeyEphemeralPub = mkStrPreference(SHARED_PREFS_IV_YUBIKEY_EPHEMERAL_PUB, null)
  val encryptedYubiKeyHkdfSalt = mkStrPreference(SHARED_PREFS_ENCRYPTED_YUBIKEY_HKDF_SALT, null)
  val initializationVectorYubiKeyHkdfSalt = mkStrPreference(SHARED_PREFS_IV_YUBIKEY_HKDF_SALT, null)
  val yubiKeyRateLimiterFailedAttempts = mkIntPreference(SHARED_PREFS_YUBIKEY_RATE_LIMITER_FAILED_ATTEMPTS, 0)
  val yubiKeyRateLimiterLockedUntil = mkLongPreference(SHARED_PREFS_YUBIKEY_RATE_LIMITER_LOCKED_UNTIL, 0L)
  val yubiKeyDatabaseId = mkStrPreference(SHARED_PREFS_YUBIKEY_DATABASE_ID, null)
  val yubiKeyEnrollmentVersion = mkIntPreference(SHARED_PREFS_YUBIKEY_ENROLLMENT_VERSION, 0)
  val yubiKeyPinLocked = mkBoolPreference(SHARED_PREFS_YUBIKEY_PIN_LOCKED, false)
  val yubiKeyPinFailedAttempts = mkIntPreference(SHARED_PREFS_YUBIKEY_PIN_FAILED_ATTEMPTS, 0)
  val yubiKeyPukFailedAttempts = mkIntPreference(SHARED_PREFS_YUBIKEY_PUK_FAILED_ATTEMPTS, 0)

  val premiumActive = mkBoolPreference(SHARED_PREFS_PREMIUM_ACTIVE, false)
  val premiumActivatedAt = mkLongPreference(SHARED_PREFS_PREMIUM_ACTIVATED_AT, 0L)
  val premiumDurationDays = mkIntPreference(SHARED_PREFS_PREMIUM_DURATION_DAYS, 30)
  val premiumDialogShown = mkBoolPreference(SHARED_PREFS_PREMIUM_DIALOG_SHOWN, false)
  val dexgramAccountId = mkStrPreference(SHARED_PREFS_DEXGRAM_ACCOUNT_ID, null)
  val dexgramToken = mkStrPreference(SHARED_PREFS_DEXGRAM_TOKEN, null)
  val dexgramExpiresAt = mkLongPreference(SHARED_PREFS_DEXGRAM_EXPIRES_AT, 0L)
  // Dexgram Vault DB backend (prod-vaultdb.dexgram.app) — separate auth, same client code
  val vaultToken = mkStrPreference(SHARED_PREFS_VAULT_TOKEN, null)
  val vaultExpiresAt = mkLongPreference(SHARED_PREFS_VAULT_EXPIRES_AT, 0L)
  val vaultMetaFileId = mkStrPreference(SHARED_PREFS_VAULT_META_FILE_ID, null)
  val yubiKeyAppLocked = mkBoolPreference(SHARED_PREFS_YUBIKEY_APP_LOCKED, false)
  val yubiKeyPukHash = mkStrPreference(SHARED_PREFS_YUBIKEY_PUK_HASH, null)
  ...
  companion object {
    ...
    private const val SHARED_PREFS_LA_MAX_FAILED_ATTEMPTS = "LAMaxFailedAttempts"
    private const val SHARED_PREFS_LA_FAILED_ATTEMPTS = "LAFailedAttempts"
...
//    private const val SHARED_PREFS_NETWORK_TCP_TIMEOUT = "NetworkTCPTimeout"
    ...
    private const val SHARED_PREFS_USERNAME_EXPIRY_TIMESTAMP = "UsernameExpiryTimestamp"
    private const val SHARED_PREFS_USERNAME_USED = "UsernameUsed"
    private const val SHARED_PREFS_PUBLIC_USERNAME = "PublicUsername"
    private const val SHARED_PREFS_PRIVATE_USERNAME = "PrivateUsername"
    private const val SHARED_PREFS_DEFAULT_CHAT_ITEM_TTL_INITIALIZED = "DefaultChatItemTTLInitialized"
    private const val SHARED_PREFS_CHAT_ITEM_TTL_WEEK_MIGRATION_DONE = "ChatItemTTLWeekMigrationDone"
    ...
    private const val SHARED_PREFS_SHOW_PUBLIC_PROFILE_WARNING = "ShowPublicProfileWarning"
    private const val SHARED_PREFS_PUBLIC_PROFILE_SETUP_COMPLETED = "PublicProfileSetupCompleted"
    ...
    private const val SHARED_PREFS_YUBIKEY_CHALLENGE = "YubiKeyChallenge"
    private const val SHARED_PREFS_YUBIKEY_UID = "YubiKeyUid"
    private const val SHARED_PREFS_USE_YUBIKEY_FOR_DB = "UseYubiKeyForDB"
    private const val SHARED_PREFS_YUBIKEY_PIN_SET = "YubiKeyPinSet"
    private const val SHARED_PREFS_YUBIKEY_PUK_SET = "YubiKeyPukSet"
    private const val SHARED_PREFS_YUBIKEY_MANAGEMENT_KEY_SET = "YubiKeyManagementKeySet"
    private const val SHARED_PREFS_YUBIKEY_PIN = "YubiKeyPin"
    private const val SHARED_PREFS_YUBIKEY_PUK = "YubiKeyPuk"
    private const val SHARED_PREFS_YUBIKEY_MANAGEMENT_KEY = "YubiKeyManagementKey"
    private const val SHARED_PREFS_ENCRYPTED_YUBIKEY_MANAGEMENT_KEY = "EncryptedYubiKeyManagementKey"
    private const val SHARED_PREFS_IV_YUBIKEY_MANAGEMENT_KEY = "IVYubiKeyManagementKey"
    private const val SHARED_PREFS_ENCRYPTED_YUBIKEY_CHALLENGE = "EncryptedYubiKeyChallenge"
    private const val SHARED_PREFS_IV_YUBIKEY_CHALLENGE = "IVYubiKeyChallenge"
    private const val SHARED_PREFS_ENCRYPTED_YUBIKEY_IDENTITY_SECRET = "EncryptedYubiKeyIdentitySecret"
    private const val SHARED_PREFS_IV_YUBIKEY_IDENTITY_SECRET = "IVYubiKeyIdentitySecret"
    private const val SHARED_PREFS_ENCRYPTED_YUBIKEY_PUBLIC_KEY = "EncryptedYubiKeyPublicKey"
    private const val SHARED_PREFS_IV_YUBIKEY_PUBLIC_KEY = "IVYubiKeyPublicKey"
    private const val SHARED_PREFS_ENCRYPTED_YUBIKEY_PUK_HASH = "EncryptedYubiKeyPukHash"
    private const val SHARED_PREFS_IV_YUBIKEY_PUK_HASH = "IVYubiKeyPukHash"
    private const val SHARED_PREFS_YUBIKEY_RATE_LIMITER_FAILED_ATTEMPTS = "YubiKeyRateLimiterFailedAttempts"
    private const val SHARED_PREFS_YUBIKEY_RATE_LIMITER_LOCKED_UNTIL = "YubiKeyRateLimiterLockedUntil"
    private const val SHARED_PREFS_YUBIKEY_DATABASE_ID = "YubiKeyDatabaseId"
    private const val SHARED_PREFS_YUBIKEY_ENROLLMENT_VERSION = "YubiKeyEnrollmentVersion"
    private const val SHARED_PREFS_YUBIKEY_PIN_LOCKED = "YubiKeyPinLocked"
    private const val SHARED_PREFS_YUBIKEY_PIN_FAILED_ATTEMPTS = "YubiKeyPinFailedAttempts"
    private const val SHARED_PREFS_YUBIKEY_PUK_FAILED_ATTEMPTS = "YubiKeyPukFailedAttempts"
    private const val SHARED_PREFS_PREMIUM_ACTIVE = "PremiumActive"
    private const val SHARED_PREFS_PREMIUM_ACTIVATED_AT = "PremiumActivatedAt"
    private const val SHARED_PREFS_PREMIUM_DURATION_DAYS = "PremiumDurationDays"
    private const val SHARED_PREFS_PREMIUM_DIALOG_SHOWN = "PremiumDialogShown"
    private const val SHARED_PREFS_DEXGRAM_ACCOUNT_ID = "DexgramAccountId"
    private const val SHARED_PREFS_DEXGRAM_TOKEN = "DexgramToken"
    private const val SHARED_PREFS_DEXGRAM_EXPIRES_AT = "DexgramExpiresAt"
    private const val SHARED_PREFS_VAULT_TOKEN = "VaultToken"
    private const val SHARED_PREFS_VAULT_EXPIRES_AT = "VaultExpiresAt"
    private const val SHARED_PREFS_VAULT_META_FILE_ID = "VaultMetaFileId"
    private const val SHARED_PREFS_YUBIKEY_APP_LOCKED = "YubiKeyAppLocked"
    private const val SHARED_PREFS_YUBIKEY_PUK_HASH = "YubiKeyPukHash"
    private const val SHARED_PREFS_ENCRYPTED_YUBIKEY_LOCKOUT_STATE = "EncryptedYubiKeyLockoutState"
    private const val SHARED_PREFS_IV_YUBIKEY_LOCKOUT_STATE = "IVYubiKeyLockoutState"
    private const val SHARED_PREFS_ENCRYPTED_YUBIKEY_WRAPPED_DMK = "EncryptedYubiKeyWrappedDMK"
    private const val SHARED_PREFS_IV_YUBIKEY_WRAPPED_DMK = "IVYubiKeyWrappedDMK"
    private const val SHARED_PREFS_ENCRYPTED_YUBIKEY_EPHEMERAL_PUB = "EncryptedYubiKeyEphemeralPub"
    private const val SHARED_PREFS_IV_YUBIKEY_EPHEMERAL_PUB = "IVYubiKeyEphemeralPub"
    private const val SHARED_PREFS_ENCRYPTED_YUBIKEY_HKDF_SALT = "EncryptedYubiKeyHkdfSalt"
    private const val SHARED_PREFS_IV_YUBIKEY_HKDF_SALT = "IVYubiKeyHkdfSalt"
...
object ChatController {
  ...
  suspend fun ensureDefaultChatItemTTLInitialized(rhId: Long?) {
    if (appPrefs.chatItemTTLWeekMigrationDone.get()) return
    try {
      setChatItemTTL(rhId, ChatItemTTL.Week)
      chatModel.chatItemTTL.value = ChatItemTTL.Week
      appPrefs.chatItemTTLWeekMigrationDone.set(true)
      appPrefs.defaultChatItemTTLInitialized.set(true)
    } catch (e: Throwable) {
      Log.e(TAG, "Failed to set default chat item TTL: ${e.stackTraceToString()}")
    }
  }
...
data class CreatedConnLink(val connFullLink: String, val connShortLink: String?) {
  /**
   * Returns the simplex chat URI for sharing.
   * @param short Whether to use the short link if available
   * @param encrypted Whether to encrypt the link using Shredgram encoding (default: true)
   */
  fun simplexChatUri(short: Boolean, encrypted: Boolean = true): String {
    val link = if (short) connShortLink ?: simplexChatLink(connFullLink)
               else simplexChatLink(connFullLink)
    return if (encrypted) chat.simplex.common.platform.ShredgramLinkEncoder.encode(link) else link
  }
  
  /**
   * Returns the original (unencrypted) simplex chat URI.
   * Useful for QR code display where the original link should be shown.
   */
  fun originalSimplexChatUri(short: Boolean): String =
  ...
  companion object {
    val defaults: AppSettings
      get() = AppSettings(
        ...
        notificationPreviewMode = AppSettingsNotificationPreviewMode.HIDDEN,
...
enum class AppSettingsNotificationPreviewMode {
  ...
  companion object {
    val default: AppSettingsNotificationPreviewMode = HIDDEN
