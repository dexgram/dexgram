...
private fun LinkAMobileLayout(
  ...
  ModalView({ appPrefs.onboardingStage.set(OnboardingStage.Step2_5_SetupDatabasePassphrase) }) {
        ...
        Box(Modifier.weight(0.7f)) {
          AddingMobileDevice(false, staleQrCode, connecting) {
            ...
            if (chatModel.remoteHosts.isEmpty() && chatModel.currentRemoteHost.value == null) {
              chatModel.controller.appPrefs.onboardingStage.set(OnboardingStage.Step2_5_SetupDatabasePassphrase)
            } else {
