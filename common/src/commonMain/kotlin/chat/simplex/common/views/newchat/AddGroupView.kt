...
fun AddGroupLayout(
  ...
  val incognito = remember { mutableStateOf(true) } // Incognito enabled by default for groups
  // Generate a random seed once for consistent avatar during group creation
  val randomSeed = remember { kotlin.random.Random.nextInt(1, 1000).toString() }
          ...
          ColumnWithScrollBar(
            ...
            TopAppBar(
              ...
              Row(
                ...
                Text(
                  text = stringResource(MR.strings.create_secret_group_title),
                  fontSize = 18.sp,
                  fontFamily = DMSans,
            ...
            OutlinedTextField(
              ...
              textStyle = LocalTextStyle.current.copy(fontSize = 16.sp, color = MaterialTheme.colors.onBackground),
