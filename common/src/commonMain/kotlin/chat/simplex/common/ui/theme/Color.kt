...
// Signal-Style Theme Colors
val SignalBlue = Color(0xFF2C6BED)  // Signal's signature blue
val SignalDarkBackground = Color(0xFF1B1B1D)  // Very dark gray (Signal dark theme)
val SignalDarkSurface = Color(0xFF2C2C2E)  // Dark gray surface
val SignalDarkReceived = Color(0xFF2C2C2E)  // Dark gray for received messages
val SignalLightReceived = Color(0xFFE6E6EA)  // Light gray for received messages (light theme)
val SignalLightBackground = Color(0xFFFFFFFF)  // White background (light theme)
