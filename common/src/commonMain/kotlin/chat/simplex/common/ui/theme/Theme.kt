...
enum class DefaultTheme {
  LIGHT, DARK, SIMPLEX, BLACK, DARKLINK;
...
data class ThemeOverrides (
  ...
  fun toColors(base: DefaultTheme, perChatTheme: ThemeColors?, perUserTheme: ThemeColors?, presetWallpaperTheme: ThemeColors?): Colors {
    val baseColors = when (base) {
      ...
      DefaultTheme.DARKLINK -> DarkLinkColorPalette
    }
  ...
  fun toAppColors(base: DefaultTheme, perChatTheme: ThemeColors?, perChatWallpaperType: WallpaperType?, perUserTheme: ThemeColors?, perUserWallpaperType: WallpaperType?, presetWallpaperTheme: ThemeColors?): AppColors {
    val baseColors = when (base) {
      ...
      DefaultTheme.DARKLINK -> DarkLinkColorPaletteApp
    }
...
val DarkColorPalette = darkColors(
  ...
  background = Color(0xFF25282B),  // DarkCharcoal800 - DexGram dark background
...
val DarkColorPaletteApp = AppColors(
  ...
  sentMessage = Color(0xFFE7EBF2),  // Light purple-gray matching sent message bubbles
  sentQuote = Color(0xFFD5DAE3),  // Slightly darker for quotes
  receivedMessage = Color(0xff262627),
  receivedQuote = Color(0xff373739),
)

val LightColorPalette = lightColors(
  primary = SignalBlue,  // Signal blue for primary actions
  primaryVariant = SignalBlue.copy(alpha = 0.8f),
  secondary = Color(0xFF8A8A8E),  // Gray for secondary text
  secondaryVariant = Color(0xFFC6C6C8),  // Light gray
  error = Color(0xFFFF3B30),  // Signal red
  background = SignalLightBackground,  // White
  surface = Color.White,
  onPrimary = Color.White,  // White text on Signal blue
...
val LightColorPaletteApp = AppColors(
  title = SignalBlue,
  primaryVariant2 = Color(0xFFF5F5F5),  // Very light gray surface
  sentMessage = Color(0xFFE7EBF2),  // Light purple-gray matching sent message bubbles
  sentQuote = Color(0xFFD5DAE3),  // Slightly darker for quotes
  receivedMessage = SignalLightReceived,  // Light gray #E6E6EA
  receivedQuote = Color(0xFFD1D1D6),  // Slightly darker for quotes
)
...
val DarkLinkColorPalette = darkColors(
  primary = SignalBlue,  // Signal blue for primary actions
  primaryVariant = SignalBlue.copy(alpha = 0.8f),  // Slightly transparent Signal blue
  secondary = Color(0xFF8A8A8E),  // Gray for secondary elements
  secondaryVariant = Color(0xFF48484A),  // Darker gray
  background = SignalDarkBackground,  // Signal dark gray background #1B1B1D
  surface = SignalDarkSurface,  // Dark gray surface #2C2C2E
  error = Color(0xFFFF3B30),  // Signal red
  onPrimary = Color.White,  // White text on Signal blue buttons
...
val DarkLinkColorPaletteApp = AppColors(
  title = Color.White,  // White for titles
  primaryVariant2 = SignalDarkSurface,  // Dark surface color
  sentMessage = Color(0xFFE7EBF2),  // Light purple-gray matching sent message bubbles
  sentQuote = Color(0xFFD5DAE3),  // Slightly darker for quotes
  receivedMessage = SignalDarkReceived,  // Dark gray for received messages #2C2C2E
  receivedQuote = Color(0xFF3A3A3C),  // Slightly lighter for quotes
)
