    ...
    when {
      ...
      onboarding == OnboardingStage.OnboardingComplete -> {
        ...
        when (state) {
          ...
          OnboardingStage.Step0_1_FeatureNoIdentity,
          OnboardingStage.Step0_2_FeatureEncryption,
          OnboardingStage.Step0_3_FeatureDecentralized,
          OnboardingStage.Step0_4_FeatureCryptoIdentity -> OnboardingPager(chatModel)
          OnboardingStage.Step2_4_ChooseUnlockMethod -> ChooseUnlockMethod(chatModel)
          OnboardingStage.Step2_4_5_SetupYubiKey -> SetupYubiKey(chatModel)
          OnboardingStage.Step2_4_5_0_YubiKeyFactoryReset -> YubiKeyFactoryResetScreen(chatModel)
          OnboardingStage.Step2_4_5_1_SetupYubiKeyPIN -> SetupYubiKeyPIN(chatModel)
          OnboardingStage.Step2_4_5_2_SetupYubiKeyPUK -> SetupYubiKeyPUK(chatModel)
          OnboardingStage.Step2_4_5_3_SetupYubiKeyManagementKey -> SetupYubiKeyManagementKey(chatModel)
          OnboardingStage.Step2_4_5_4_EncryptDatabaseYubiKey -> EncryptDatabaseWithYubiKey(chatModel)
          OnboardingStage.Step2_5_SetupDatabasePassphrase -> SetupDatabasePassphrase(chatModel)
          OnboardingStage.Step2_6_SetupSelfDestruct -> SetupSelfDestruct(chatModel)
