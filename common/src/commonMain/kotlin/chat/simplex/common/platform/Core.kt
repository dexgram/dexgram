    ...
    if (user == null) {
      ...
      if (appPlatform.isDesktop) {
        ...
        if (chatController.listRemoteHosts()?.isEmpty() == true) {
          chatController.appPrefs.onboardingStage.set(OnboardingStage.Step0_1_FeatureNoIdentity)
        }
        chatController.startChatWithoutUser()
      } else {
        val currentStage = chatController.appPrefs.onboardingStage.get()
        val inSetupFlow = currentStage in listOf(
          OnboardingStage.Step2_4_ChooseUnlockMethod,
          OnboardingStage.Step2_4_5_SetupYubiKey,
          OnboardingStage.Step2_4_5_0_YubiKeyFactoryReset,
          OnboardingStage.Step2_4_5_1_SetupYubiKeyPIN,
          OnboardingStage.Step2_4_5_2_SetupYubiKeyPUK,
          OnboardingStage.Step2_4_5_3_SetupYubiKeyManagementKey,
          OnboardingStage.Step2_4_5_4_EncryptDatabaseYubiKey,
          OnboardingStage.Step2_5_SetupDatabasePassphrase,
          OnboardingStage.Step2_6_SetupSelfDestruct,
