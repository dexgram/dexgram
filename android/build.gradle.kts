...
android {
    ...
    defaultConfig {
        ...
        manifestPlaceholders["provider_authorities"] = "com.dexgram.app.provider"
    ...
    buildTypes {
        debug {
            ...
            manifestPlaceholders["provider_authorities"] = "com.dexgram.app${rootProject.extra["application_id.suffix"]}.provider"
        }
        release {
    ...
    val compressApk by creating {
        doLast {
            ...
            if (project.properties["android.injected.signing.key.alias"] != null && buildType == "release") {
                File(outputDir, "android-release.apk").renameTo(File(outputDir, "dexgram.apk"))
                File(outputDir, "android-armeabi-v7a-release.apk").renameTo(File(outputDir, "dexgram-armv7a.apk"))
                File(outputDir, "android-arm64-v8a-release.apk").renameTo(File(outputDir, "dexgram.apk"))
            }
